...

{
	...
	echo "dietpi ALL=(ALL) NOPASSWD: /usr/bin/pkill -f /usr/local/bin/mupibox/sleep_timer.sh, /bin/rm -f /tmp/.time2sleep, /usr/bin/nohup /usr/local/bin/mupibox/sleep_timer.sh *" >> /etc/sudoers.d/mupibox-dietpi >&3 2>&3
